...
while running:
    ...
    F2 = (F1[0] * -1, F1[1] * -1)
    v1 = (v1[0] + F1[0] / M1 * koef * dt, v1[1] + F1[1] / M1 * koef * dt)    
    v2 = (v2[0] + F2[0] / M2 * koef * dt, v2[1] + F2[1] / M2 * koef * dt)
    ...
    for i_graf in range(0, int(WIDTH)):
        ...
        pygame.draw.aaline(screen, CLR1, (WIDTH - i_graf, HEIGHT - height_graf - y1), (WIDTH - i_graf - 1, HEIGHT - height_graf - y2))
        pygame.draw.aaline(screen, CLR2, (WIDTH - i_graf, HEIGHT - height_graf + y1), (WIDTH - i_graf - 1, HEIGHT - height_graf + y2))
