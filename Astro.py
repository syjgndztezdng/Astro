import pygame
import math
import scipy #для констант
from simpleeval import simple_eval

#единицы измерения км, сек, кг
...
height_graf = 50
koef = 10 ** 5
k_len = 5 / 149.6 / 10 ** 6 #коэф для растояний км в пиксели(ае)
angle_F = 1
nak = 0
grid = 20 #четное

P = math.sqrt(4 * math.pi * a ** 3 / scipy.constants.G / (M1 + M2)) #из кеплера
v1 = (0, math.sqrt(scipy.constants.G * M1 / a)) #интеграл энергии
v2 = (0, math.sqrt(scipy.constants.G * M2 / a)) #интеграл энергии
pos1 = (-1 * a, 10 / k_len)
pos2 = (a, -10 / k_len)
F1 = (0, 0)
F2 = (0, 0)
